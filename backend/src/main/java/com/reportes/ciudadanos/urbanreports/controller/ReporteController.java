...
public class ReporteController {
    ...
    public ReporteResponse crear(
        ...
        Reporte r = reporteService.crearReporte(
                telefono, tipoDeReporte, descripcion,
    ...
    // =====================================
    //   OBTENER DETALLE POR ID (PUBLICO,
    //   SI QUIERES TAMBIÉN LO PROTEGEMOS)
    // =====================================
    @GetMapping("/{id}")
    ...
    //   (SI QUIERES SOLO ADMIN, DIME Y LO AGREGO)
    // =====================================
